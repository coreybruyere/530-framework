...
* **The primary purpose of a class name is to be a hook for CSS.(Use ID's for JS and the prefix 'js-' when possible)** If you don’t need to add presentation and behaviour to your web documents, then you probably don’t need classes in your HTML.
